...
public final class Tuple implements Serializable {
	 ...
	 * @see {@link Tuple#map(ca.eandb.jmist.toolkit.Tuple.Function)}
	 */
	 ...
	 * @see {@link Tuple#combine(Tuple, ca.eandb.jmist.toolkit.Tuple.Operator)},
	 * 		{@link Tuple#reduce(ca.eandb.jmist.toolkit.Tuple.Operator)},
	 * 		{@link Tuple#reduce(ca.eandb.jmist.toolkit.Tuple.Operator, double)}.
	 */
	 ...
	 * 		{@link #reduce(ca.eandb.jmist.toolkit.Tuple.Operator)},
	 ...
	 * @see {@link Tuple#filter(ca.eandb.jmist.toolkit.Tuple.Filter)}.
	 */
