...
public final class Grid3 implements Serializable {
	...
	/**
	 * An interface to allow {@link Grid3#intersect(Ray3, Interval, ca.eandb.jmist.toolkit.Grid3.Visitor)}
	 * to notify the caller about each cell passed through by the ray.
	 * @see {@link Grid3#intersect(Ray3, Interval, ca.eandb.jmist.toolkit.Grid3.Visitor)}
	 */
	public static interface Visitor {
		 ...
		 * return true.
		 * @param ray The ray passed to {@link Grid3#intersect(Ray3, Interval, ca.eandb.jmist.toolkit.Grid3.Visitor)}
		 ...
		 * @return A value indicating whether {@link Grid3#intersect(Ray3, Interval, ca.eandb.jmist.toolkit.Grid3.Visitor)}
