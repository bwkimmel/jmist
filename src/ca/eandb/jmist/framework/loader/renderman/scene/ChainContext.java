...
import ca.eandb.jmist.framework.loader.renderman.RtPointer;
import ca.eandb.jmist.framework.loader.renderman.RtProcFreeFunc;
 ...
 *
 */
public abstract class ChainContext implements RenderManContext {
	
	private ChainContext parent;
	private RenderManContext inner;
	...
	public void archiveRecord(RtToken type, String format, String... arg) {
		if (inner != null) {
			...
			outer.archiveRecord(type, format, arg);
		}
	}

	/* (non-Javadoc)
	 * @see ca.eandb.jmist.framework.loader.renderman.RenderManContext#areaLightSource(ca.eandb.jmist.framework.loader.renderman.RtToken, java.lang.Object[])
	 */
	@Override
	public RtLightHandle areaLightSource(RtToken shadername,
			Object... parameterlist) {
		return inner != null ? inner.areaLightSource(shadername, parameterlist)
				: outer.areaLightSource(shadername, parameterlist);
	}

	/* (non-Javadoc)
	 * @see ca.eandb.jmist.framework.loader.renderman.RenderManContext#atmosphere(ca.eandb.jmist.framework.loader.renderman.RtToken, java.lang.Object[])
	 */
	@Override
	public void atmosphere(RtToken shadername, Object... parameterlist) {
		if (inner != null) {
			inner.atmosphere(shadername, parameterlist);
		} else {
			outer.atmosphere(shadername, parameterlist);
		}
	}

	/* (non-Javadoc)
	 * @see ca.eandb.jmist.framework.loader.renderman.RenderManContext#attribute(ca.eandb.jmist.framework.loader.renderman.RtToken, java.lang.Object[])
	 */
	@Override
	public void attribute(RtToken name, Object... parameterlist) {
		if (inner != null) {
			inner.attribute(name, parameterlist);
		} else {
			outer.attribute(name, parameterlist);
		}
	}
	...
	/* (non-Javadoc)
	 * @see ca.eandb.jmist.framework.loader.renderman.RenderManContext#blobby(int, int, int[], int, double[], int, java.lang.String[], java.lang.Object[])
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ca.eandb.jmist.framework.loader.renderman.RenderManContext#cone(double, double, double, java.lang.Object[])
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ca.eandb.jmist.framework.loader.renderman.RenderManContext#curves(ca.eandb.jmist.framework.loader.renderman.RtToken, int, int[], ca.eandb.jmist.framework.loader.renderman.RtToken, java.lang.Object[])
	 */
	@Override
	public void curves(RtToken type, int ncurves, int[] nvertices,
			RtToken wrap, Object... parameterlist) {
		// TODO Auto-generated method stub

	}

	/* (non-Javadoc)
	 * @see ca.eandb.jmist.framework.loader.renderman.RenderManContext#cylinder(double, double, double, double, java.lang.Object[])
	 */
	@Override
	public void cylinder(double radius, double zmin, double zmax,
			double thetamax, Object... parameterlist) {
		// TODO Auto-generated method stub
	...
	/* (non-Javadoc)
	 * @see ca.eandb.jmist.framework.loader.renderman.RenderManContext#disk(double, double, double, java.lang.Object[])
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ca.eandb.jmist.framework.loader.renderman.RenderManContext#displacement(ca.eandb.jmist.framework.loader.renderman.RtToken, java.lang.Object[])
	 */
	@Override
	public void displacement(RtToken shadername, Object... parameterlist) {
		// TODO Auto-generated method stub
	...
	/* (non-Javadoc)
	 * @see ca.eandb.jmist.framework.loader.renderman.RenderManContext#exterior(ca.eandb.jmist.framework.loader.renderman.RtToken, java.lang.Object[])
	 */
	@Override
	public void exterior(RtToken shadername, Object... parameterlist) {
		// TODO Auto-generated method stub
	...
	/* (non-Javadoc)
	 * @see ca.eandb.jmist.framework.loader.renderman.RenderManContext#generalPolygon(int, int[], java.lang.Object[])
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ca.eandb.jmist.framework.loader.renderman.RenderManContext#geometry(ca.eandb.jmist.framework.loader.renderman.RtToken, java.lang.Object[])
	 */
	@Override
	public void geometry(RtToken type, Object... parameterlist) {
		// TODO Auto-generated method stub

	}

	/* (non-Javadoc)
	 * @see ca.eandb.jmist.framework.loader.renderman.RenderManContext#getLastError()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ca.eandb.jmist.framework.loader.renderman.RenderManContext#hider(ca.eandb.jmist.framework.loader.renderman.RtToken, java.lang.Object[])
	 */
	@Override
	public void hider(RtToken type, Object... parameterlist) {
		// TODO Auto-generated method stub

	}

	/* (non-Javadoc)
	 * @see ca.eandb.jmist.framework.loader.renderman.RenderManContext#hyperboloid(ca.eandb.jmist.framework.loader.renderman.RtPoint, ca.eandb.jmist.framework.loader.renderman.RtPoint, double, java.lang.Object[])
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ca.eandb.jmist.framework.loader.renderman.RenderManContext#imager(ca.eandb.jmist.framework.loader.renderman.RtToken, java.lang.Object[])
	 */
	@Override
	public void imager(RtToken name, Object... parameterlist) {
		// TODO Auto-generated method stub

	}

	/* (non-Javadoc)
	 * @see ca.eandb.jmist.framework.loader.renderman.RenderManContext#interior(ca.eandb.jmist.framework.loader.renderman.RtToken, java.lang.Object[])
	 */
	@Override
	public void interior(RtToken shadername, Object... parameterlist) {
		// TODO Auto-generated method stub

	}

	/* (non-Javadoc)
	 * @see ca.eandb.jmist.framework.loader.renderman.RenderManContext#lightSource(ca.eandb.jmist.framework.loader.renderman.RtToken, java.lang.Object[])
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ca.eandb.jmist.framework.loader.renderman.RenderManContext#makeCubeFaceEnvironment(java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, double, ca.eandb.jmist.framework.loader.renderman.RtFilterFunc, double, double, java.lang.Object[])
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ca.eandb.jmist.framework.loader.renderman.RenderManContext#makeLatLongEnvironment(java.lang.String, java.lang.String, ca.eandb.jmist.framework.loader.renderman.RtFilterFunc, double, double, java.lang.Object[])
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ca.eandb.jmist.framework.loader.renderman.RenderManContext#makeShadow(java.lang.String, java.lang.String, java.lang.Object[])
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ca.eandb.jmist.framework.loader.renderman.RenderManContext#makeTexture(java.lang.String, java.lang.String, ca.eandb.jmist.framework.loader.renderman.RtToken, ca.eandb.jmist.framework.loader.renderman.RtToken, ca.eandb.jmist.framework.loader.renderman.RtFilterFunc, double, double, java.lang.Object[])
	 */
	@Override
	public void makeTexture(String picturename, String texturename,
			RtToken swrap, RtToken twrap, RtFilterFunc filterfunc,
			double swidth, double twidth, Object... parameterlist) {
		// TODO Auto-generated method stub
	...
	/* (non-Javadoc)
	 * @see ca.eandb.jmist.framework.loader.renderman.RenderManContext#option(ca.eandb.jmist.framework.loader.renderman.RtToken, java.lang.Object[])
	 */
	@Override
	public void option(RtToken name, Object... parameterlist) {
		// TODO Auto-generated method stub
	...
	/* (non-Javadoc)
	 * @see ca.eandb.jmist.framework.loader.renderman.RenderManContext#paraboloid(double, double, double, double, java.lang.Object[])
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ca.eandb.jmist.framework.loader.renderman.RenderManContext#patch(ca.eandb.jmist.framework.loader.renderman.RtToken, java.lang.Object[])
	 */
	@Override
	public void patch(RtToken type, Object... parameterlist) {
		// TODO Auto-generated method stub

	}

	/* (non-Javadoc)
	 * @see ca.eandb.jmist.framework.loader.renderman.RenderManContext#patchMesh(ca.eandb.jmist.framework.loader.renderman.RtToken, int, ca.eandb.jmist.framework.loader.renderman.RtToken, int, ca.eandb.jmist.framework.loader.renderman.RtToken, java.lang.Object[])
	 */
	@Override
	public void patchMesh(RtToken type, int nu, RtToken uwrap, int nv,
			RtToken vwrap, Object... parameterlist) {
		// TODO Auto-generated method stub
	...
	/* (non-Javadoc)
	 * @see ca.eandb.jmist.framework.loader.renderman.RenderManContext#points(int, java.lang.Object[])
	 */
	@Override
	public void points(int npoints, Object... parameterlist) {
		// TODO Auto-generated method stub

	}

	/* (non-Javadoc)
	 * @see ca.eandb.jmist.framework.loader.renderman.RenderManContext#pointsGeneralPolygons(int, int[], int[], int[], java.lang.Object[])
	 */
	@Override
	public void pointsGeneralPolygons(int npolys, int[] nloops,
			int[] nvertices, int[] vertices, Object... parameterlist) {
		// TODO Auto-generated method stub

	}

	/* (non-Javadoc)
	 * @see ca.eandb.jmist.framework.loader.renderman.RenderManContext#pointsPolygons(int, int[], int[], java.lang.Object[])
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ca.eandb.jmist.framework.loader.renderman.RenderManContext#polygon(int, java.lang.Object[])
	 */
	@Override
	public void polygon(int nvertices, Object... parameterlist) {
		// TODO Auto-generated method stub

	}

	/* (non-Javadoc)
	 * @see ca.eandb.jmist.framework.loader.renderman.RenderManContext#procDynamicLoad(ca.eandb.jmist.framework.loader.renderman.RtPointer, double)
	 */
	@Override
	public void procDynamicLoad(RtPointer data, double detail) {
		// TODO Auto-generated method stub

	}

	/* (non-Javadoc)
	 * @see ca.eandb.jmist.framework.loader.renderman.RenderManContext#procRunProgram(ca.eandb.jmist.framework.loader.renderman.RtPointer, double)
	 */
	@Override
	public void procRunProgram(RtPointer data, double detail) {
		// TODO Auto-generated method stub

	}

	/* (non-Javadoc)
	 * @see ca.eandb.jmist.framework.loader.renderman.RenderManContext#procedural(ca.eandb.jmist.framework.loader.renderman.RtPointer, ca.eandb.jmist.framework.loader.renderman.RtBound, ca.eandb.jmist.framework.loader.renderman.RtProcSubdivFunc, ca.eandb.jmist.framework.loader.renderman.RtProcFreeFunc)
	 */
	@Override
	public void procedural(RtPointer data, RtBound bound,
	...
	/* (non-Javadoc)
	 * @see ca.eandb.jmist.framework.loader.renderman.RenderManContext#projection(ca.eandb.jmist.framework.loader.renderman.RtToken, java.lang.Object[])
	 */
	@Override
	public void projection(RtToken name, Object... parameterlist) {
		// TODO Auto-generated method stub
	...
	/* (non-Javadoc)
	 * @see ca.eandb.jmist.framework.loader.renderman.RenderManContext#readArchive(ca.eandb.jmist.framework.loader.renderman.RtToken, ca.eandb.jmist.framework.loader.renderman.RtArchiveCallback, java.lang.Object[])
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ca.eandb.jmist.framework.loader.renderman.RenderManContext#sphere(double, double, double, double, java.lang.Object[])
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ca.eandb.jmist.framework.loader.renderman.RenderManContext#subdivisionMesh(ca.eandb.jmist.framework.loader.renderman.RtToken, int, int[], int[], int, ca.eandb.jmist.framework.loader.renderman.RtToken[], int[], int[], double[], java.lang.Object[])
	 */
	@Override
	public void subdivisionMesh(RtToken scheme, int nfaces, int[] nvertices,
			int[] vertices, int ntags, RtToken[] tags, int[] nargs,
			int[] intargs, double[] doubleargs, Object... parameterlist) {
		// TODO Auto-generated method stub

	}

	/* (non-Javadoc)
	 * @see ca.eandb.jmist.framework.loader.renderman.RenderManContext#surface(ca.eandb.jmist.framework.loader.renderman.RtToken, java.lang.Object[])
	 */
	@Override
	public void surface(RtToken shadername, Object... parameterlist) {
		// TODO Auto-generated method stub
	...
	/* (non-Javadoc)
	 * @see ca.eandb.jmist.framework.loader.renderman.RenderManContext#torus(double, double, double, double, double, java.lang.Object[])
	 */
	@Override
	public void torus(double majorradius, double minorradius, double phimin,
			double phimax, double thetamax, Object... parameterlist) {
		// TODO Auto-generated method stub
