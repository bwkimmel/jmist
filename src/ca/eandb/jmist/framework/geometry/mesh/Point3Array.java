...
/**
 * A <code>List</code> of <code>Point3</code>s that stores its elements more
 * compactly than <code>ArrayList&lt;Point3&gt;</code>.
 * 
 * @author Brad Kimmel
 */
public final class Point3Array extends AbstractList<Point3> implements
	 ...
	 */
	@Override
	public Point3 set(int index, Point3 element) {
		int base = index * 3;
		Point3 p = new Point3(
				coords.get(base + 0),
				coords.get(base + 1),
	 ...
	 */
	@Override
	public void add(int index, Point3 element) {
