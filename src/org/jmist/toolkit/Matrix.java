...
public final class Matrix {
	 ...
	 * @param row The row of the element to obtain.
	 * @param col The column of the element to obtain.
	 ...
	 * @param row The row of the element to get the index of.
	 * @param col The column of the element to get the index of.
	 ...
	 * @param row The index of the first row of the sub-matrix.
	 * @param col The index of the first column of the sub-matrix.
	 * @param rows The number of rows of the sub-matrix.
	 * @param cols The number of columns of the sub-matrix.
	 ...
	 * @param rows The number of rows in the <code>Matrix</code>.
	 * @param cols The number of columns in the <code>Matrix</code>.
	 ...
	 * @param n The size of the <code>Matrix</code>.
